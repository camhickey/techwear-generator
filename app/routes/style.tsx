...
function getColorFromHexCode(value: string) {
...
export default function Style() {
    ...
    const [outfit, setOutfit] = useState({
        headwearColor: colorMap['BLACK'],
        topColor: colorMap['BLACK'],
        bottomsColor: colorMap['BLACK'],
        footwearColor: colorMap['BLACK'],
    })
        ...
        <div className='flex flex-col items-center gap-5'>
             <div className='flex flex-row justify-center items-center gap-5'>
                <div className='flex flex-col gap-5'>
                    {Object.entries(colorMap).map(([colorName, colorValue]) => (
                        <div key={colorName} className='w-10 h-10 rounded-full hover:cursor-pointer' style={{backgroundColor: colorValue}} onClick={() => setSelectedColor(colorValue)} />
                    ))}
                </div>
                <svg
                version="1.0"
                ...
                xmlns="http://www.w3.org/2000/svg">
                    <g transform="translate(0.000000,1000.000000) scale(0.100000,-0.100000)">
                        ...
                        <g className="shoes"
                        fill={outfit.footwearColor}
                        onClick={() => {setOutfit({...outfit, footwearColor: selectedColor});}}>
                        ...
                        <g className="pants"
                        fill={outfit.bottomsColor}
                        onClick={() => {setOutfit({...outfit, bottomsColor: selectedColor});}}>
                        ...
                        onClick={() => {setOutfit({...outfit, topColor: selectedColor});}}>
                        ...
                        fill={outfit.headwearColor}
                        onClick={() => {setOutfit({...outfit, headwearColor: selectedColor});}}>
            ...
            <div className='flex flex-row items-center gap-5'>
                <div className='w-10 h-10 rounded-full border-black border-2 border-solid' style={{backgroundColor: selectedColor}} />
                <p className='font-bold'>{getColorFromHexCode(selectedColor)}</p>
            </div>
            <CustomButton>GET OUTFIT</CustomButton>
            <HelpModal />
        </div>
    )
}